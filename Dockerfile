...
RUN set -x \
 && apk add --no-cache git zip terraform vim openssh py3-pip gcc libc-dev python3-dev openssl-dev helm tree curl tar bash jq yq rsync sshpass \
...
>> /etc/ansible/ansible.cfg \
 ...
 && curl -L https://get.helm.sh/helm-v3.9.0-linux-amd64.tar.gz | tar zx -C /tmp/ \
